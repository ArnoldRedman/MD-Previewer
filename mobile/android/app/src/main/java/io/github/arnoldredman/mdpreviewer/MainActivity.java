package io.github.arnoldredman.mdpreviewer;
...
public final class MainActivity extends Activity {
    ...
    private void configureWebView() {
        ...
        webView.addJavascriptInterface(new Bridge(), "MDPreviewerAndroid");
    ...
    private String displayedTitle() {
        ...
        return title.toString().replace(" - MD Previewer", "");
    }
    ...
    private void sendRecentToWeb() {
        evaluate("window.MDPreviewer && window.MDPreviewer.setRecent(" + recentFiles() + ");");
    }
