...
pub(crate) struct Strings {
    ...
    pub(crate) set_title: &'static str,
    pub(crate) set_tab_general: &'static str,
    pub(crate) set_tab_shortcuts: &'static str,
    pub(crate) set_all_shortcuts: &'static str,
    pub(crate) set_shortcuts_enabled: &'static str,
    pub(crate) set_shortcuts_disabled: &'static str,
    pub(crate) set_log_label: &'static str,
    pub(crate) btn_open_log: &'static str,
    pub(crate) btn_clear_log: &'static str,
    pub(crate) shortcut_close_tab: &'static str,
    pub(crate) shortcut_new_file: &'static str,
    pub(crate) shortcut_open_file: &'static str,
    pub(crate) shortcut_save: &'static str,
    pub(crate) shortcut_save_as: &'static str,
    pub(crate) shortcut_toggle_edit: &'static str,
    pub(crate) shortcut_split_view: &'static str,
    pub(crate) shortcut_find: &'static str,
    pub(crate) shortcut_refresh: &'static str,
    pub(crate) shortcut_zoom_in: &'static str,
    pub(crate) shortcut_zoom_out: &'static str,
    pub(crate) shortcut_zoom_reset: &'static str,
    pub(crate) shortcut_print: &'static str,
    pub(crate) shortcut_escape: &'static str,
}
    ...
    pub(crate) fn for_lang(lang: Lang) -> Self {
        match lang {
            Lang::Zh => Strings {
                ...
                set_title: "偏好设置",
                set_tab_general: "常规",
                set_tab_shortcuts: "快捷键",
                set_all_shortcuts: "全部快捷键",
                set_shortcuts_enabled: "启用",
                set_shortcuts_disabled: "禁用",
                set_log_label: "运行与崩溃日志",
                btn_open_log: "查看日志",
                btn_clear_log: "清理日志",
                shortcut_close_tab: "关闭当前标签",
                shortcut_new_file: "新建文档",
                shortcut_open_file: "打开文档",
                shortcut_save: "保存文档",
                shortcut_save_as: "另存为",
                shortcut_toggle_edit: "切换编辑模式",
                shortcut_split_view: "分屏实时预览",
                shortcut_find: "页面搜索",
                shortcut_refresh: "刷新文档",
                shortcut_zoom_in: "放大字号",
                shortcut_zoom_out: "缩小字号",
                shortcut_zoom_reset: "重置字号",
                shortcut_print: "打印文档",
                shortcut_escape: "退出编辑/关闭浮层",
            },
            Lang::En => Strings {
                ...
                set_all_shortcuts: "All Shortcuts",
                set_shortcuts_enabled: "Enable",
                set_shortcuts_disabled: "Disable",
                set_log_label: "Logs & Crash Reports",
                btn_open_log: "Open Log",
                btn_clear_log: "Clear Log",
                shortcut_close_tab: "Close Tab",
                shortcut_new_file: "New File",
                shortcut_open_file: "Open File",
                shortcut_save: "Save Document",
                shortcut_save_as: "Save As",
                shortcut_toggle_edit: "Toggle Edit Mode",
                shortcut_split_view: "Split View",
                shortcut_find: "Find in Page",
                shortcut_refresh: "Refresh Document",
                shortcut_zoom_in: "Zoom In",
                shortcut_zoom_out: "Zoom Out",
                shortcut_zoom_reset: "Reset Zoom",
                shortcut_print: "Print Document",
                shortcut_escape: "Exit Edit / Close Overlays",
            },
        }
    }
}
